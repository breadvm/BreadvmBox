...
configure.bat -confirm-license -opensource -platform win32-msvc2010 -release -shared -prefix "c:\Qt\shared-win64" -no-openssl -no-qml-debug ^
-opengl desktop -no-icu -no-harfbuzz -no-angle -nomake tests -nomake examples ^
